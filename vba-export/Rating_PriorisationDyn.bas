Attribute VB_Name = "Rating_PriorisationDyn"
Option Explicit
...
Sub PriorisationsDyn(ByVal onglet As String)
...
'                        Call putResutat(Onglet, val(ThisWorkbook.sheets("CONFIGURATIONS SEETINGS").Cells(Types + 3, 6)))
                   ...
                   If checkLeftRight(parametreLigne, OperationLigne) = True And isValeur = False And checkIfColumnExists(parametreLigne, onglet) = True Then
                       pLigne = (ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreLigne, LookAt:=xlWhole).Column))
                      If Len(ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreLigne, LookAt:=xlWhole).Column)) <> 0 Then
                  ...
                  If checkIfColumnExists(parametreColonneGauche, onglet) = True And checkLeftRight(parametreColonneGauche, OperationColonneGauche) = True And checkLeftRight(parametreColonneDroite, OperationColonneDroite) = True And isValeur = False Then
                     GetColGauche = True
                     GetColDroite = True
                     TablT(0) = (ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneGauche, LookAt:=xlWhole).Column))
                     TablT(1) = (ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneDroite, LookAt:=xlWhole).Column))
                     If Len(ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneGauche, LookAt:=xlWhole).Column)) <> 0 And _
                        Len(ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneDroite, LookAt:=xlWhole).Column)) <> 0 Then
                  ...
                  If checkIfColumnExists(parametreColonneDroite, onglet) = True And checkLeftRight(parametreColonneDroite, OperationColonneDroite) = True And checkLeftRight(parametreColonneGauche, OperationColonneGauche) = False And isValeur = False Then
                     GetColDroite = True
                     pLigne = (ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneDroite, LookAt:=xlWhole).Column))
                     If Len(ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneDroite, LookAt:=xlWhole).Column)) <> 0 Then
                  ...
                  If checkIfColumnExists(parametreColonneGauche, onglet) = True And checkLeftRight(parametreColonneDroite, OperationColonneDroite) = False And checkLeftRight(parametreColonneGauche, OperationColonneGauche) = True And isValeur = False Then
                     GetColGauche = True
                     pLigne = (ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneGauche, LookAt:=xlWhole).Column))
                     If Len(ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=parametreColonneGauche, LookAt:=xlWhole).Column)) <> 0 Then
                    ...
                    If isValeur = False Then
                         If GetColGauche = True And GetColDroite = True Then
                            If (checkLeftRight(parametreLigne, OperationLigne) = True And CrLeft = CrRight And CrRight <> 0 And Cc <> 0) Then
                                    ...
                                    Call CompteSumPriorityDyn.storeListDyn(keyPriorite, k, rowStart)
...
Function checkIfColumnExists(recherches As String, onglet As String) As Boolean
        ...
        With ThisWorkbook.sheets(onglet)
                If .Range("BH6:GG6").Cells.Find(What:=recherches, LookAt:=xlWhole) Is Nothing Then
...
Function putResutat(onglet As String, Resu As Integer)
                ...
                If Resu = 1 Or Resu = 2 Or Resu = 3 Then
                     Set r = ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column)
                     If celResu(Resu) Is Nothing Then Set celResu(Resu) = r Else Set celResu(Resu) = Union(celResu(Resu), r)
                    ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column) = Resu
'                    ThisWorkbook.Sheets(onglet).Cells(k, ThisWorkbook.Sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column).Interior.Color = Color(Resu)
                Else
                    ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column) = "/"
                End If

                If ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column) = 1 Then
                    If ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "RED" Then
                        NP1R = NP1R + 1
                    ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "YELLOW" Then
                        NP1Y = NP1Y + 1
                    ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "GREEN" Then
                        NP1G = NP1G + 1
                    End If

                ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column) = 2 Then
                    If ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "RED" Then
                        NP2R = NP2R + 1
                    ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "YELLOW" Then
                        NP2Y = NP2Y + 1
                ...
                ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:=Str, LookAt:=xlWhole).Column) = 3 Then
                    If ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "RED" Then
                        NP3R = NP3R + 1
                    ElseIf ThisWorkbook.sheets(onglet).Cells(k, ThisWorkbook.sheets(onglet).Range("BH6:GG6").Cells.Find(What:="Event Rating", LookAt:=xlWhole).Column) = "YELLOW" Then
                        NP3Y = NP3Y + 1
